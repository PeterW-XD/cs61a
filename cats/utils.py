...
def lines_from_file(path):
    ...
    with open(path, 'r') as f:
        return [line.strip() for line in f.readlines()] # Remove any leading and trailing spaces
...
def remove_punctuation(s):
    ...
    'Its a lovely day dont you think'
    """
    punctuation_remover = str.maketrans('', '', string.punctuation) # maketrans creates a mapping table
